...
function images(handle: string) {
	...
	return {
		edges: [
			...
			{ node: { url: `/images/shoes/${basename}.svg`, altText: `${handle} - side view`, width: 800, height: 800 } },
			{ node: { url: `/images/shoes/${basename}.svg`, altText: `${handle} - sole view`, width: 800, height: 800 } }
		]
	};
}
